...
VALUES
  (1, 'Whisky Jack Daniel N°7 1 Lt con dosificador', 'whisky', 1000, 15500, 15000),
  (2, 'Whisky Jack Daniel Manzana 1 Lt con dosificador', 'whisky', 1000, 16000, 15500),
  (3, 'Whisky Jack Daniel Honey 1 Lt', 'whisky', 1000, 15500, 15000),
  (4, 'Whisky Jack Daniel Fire 1 Lt', 'whisky', 1000, 15500, 15000),
  (5, 'Whisky Black Label 1 Lt', 'whisky', 1000, 23000, 22500),
  (6, 'Whisky Red Label 1 Lt', 'whisky', 1000, 10000, 9500),
  (7, 'Ballantine Finest 1 Lt', 'whisky', 1000, 8590, 8090),
  (8, 'Chivas Regal 12 años 1 Lt', 'whisky', 1000, 16900, 16400),
  (9, 'Whisky Old Par 1 Lt', 'whisky', 1000, 23000, 22500),
  (10, 'Whisky Royal Circle 1 Lt', 'whisky', 1000, 4900, 4400),
  (11, 'Whisky Royal Circle Honey 1 Lt', 'whisky', 1000, 5500, 5000),
  (12, 'Whisky Royal Circle 200ml x48 un Black', 'whisky', 200, 990, 490),
  (13, 'Royal Circle Whisky & Cola 330ml x24', 'whisky', 330, 990, 490),
  (14, 'Ron Havana Club añejo Especial 1 Lt', 'ron', 1000, 6590, 6090),
  (15, 'Havana Club Reserva 1 Lt', 'ron', 1000, 8590, 8090),
  (16, 'Havana Club 7 años', 'ron', null, 9590, 9090),
  (17, 'Havana Club 3 años 1 Lt', 'ron', 1000, 6590, 6090),
  (18, 'Havana Especial 750ml', 'ron', 750, 5500, 5000),
  (19, 'Havana Reserva 750ml', 'ron', 750, 6500, 6000),
  (20, 'Ron Abuelo añejo 1 Lt', 'ron', 1000, 6000, 5500),
  ...
  (25, 'Flor de Caña 4 años 1 Lt', 'ron', 1000, 7900, 7400),
  (26, 'Flor de Caña 7 años 1 Lt', 'ron', 1000, 10500, 10000),
  (27, 'Ron Barcelo añejo 1 Lt', 'ron', 1000, 6000, 5500),
  (28, 'Ron Barcelo blanco 1 Lt', 'ron', 1000, 4500, 4000),
  ...
  (35, 'Licor Jagermeister 1 Lt 35°Alc', 'licor', 1000, 10690, 10190),
  (36, 'Aguardiente Antiqueño 750ml', 'aguardiente', 750, 7900, 7400),
  (37, 'Aguardiente Blanco del Valle 1 Lt', 'aguardiente', 1000, 8000, 7500),
  (38, 'Tequila Dona camila c/g 1 Lt', 'tequila', 1000, 6500, 6000),
  (39, 'Tequila Dona camila s/g 1 Lt', 'tequila', 1000, 6500, 6000),
